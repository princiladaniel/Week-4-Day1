...
public class LearnSortable {
	...
	public static void main(String[] args) {
		...
		Actions builder = new Actions(driver);
		builder.dragAndDrop(item6, item1).dragAndDrop(item5, item2).dragAndDrop(item4, item3).dragAndDrop(item3, item3).dragAndDrop(item2, item2).dragAndDrop(item2,item1).perform();
